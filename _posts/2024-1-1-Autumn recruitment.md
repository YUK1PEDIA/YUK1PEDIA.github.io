...
饿了么笔试，算法题三道题 a 了两道，最后一道过了 30%

还有八道选择题和七道不定项，考察数据结构、计算机网络、设计模式、linux 操作系统和少量行测申论



## 2025/3/8

淘天笔试，算法题只 a 了一道，第二题贪心+堆忘了优先队列怎么写，第三题图论不会

美团笔试，算法 a 了 1.5 道，第一题纯模拟可能边界没处理好，第三题图论听说铜牌题水平，不会



## 2025/3/9

拼多多笔试，a 了签到题和一道 dp ，第三题好像是背包，没 a 出来，第四题没看
...
1. 做题，第一道不太好描述，反正不难；第二道计算日期差
2. 聊参与开发的实际项目
3. 索引是什么，缺点
4. 什么时候开始学后端的
5. git rebase 知道吗（不知道）
6. redis 持久化
7. redis 客户侧缓存了解吗（不了解，回答了 nacos 客户侧缓存）
8. 讲讲你的分布式项目
9. 场景：如果说我现在加一个需求，实现用户购买商品增加积分，付款的时候可以使用积分抵扣，怎么设计
10. http 状态码，4xx 和 5xx 的区别
11. 除了和导师做的项目和自己的项目，有没有其他技术上的经历
12. 哪里人
13. 到岗时间，实习时间

基本在聊天，面试官挺和善的，比较强调工程思维
