...
10. java 怎么管理内存的（gc）
11. 在学什么新技术？
12. AI 底层了解吗？（被问到过好多次了）
13. 老家哪的，未来规划
14. 博弈：550个瓶子，A 和 B 轮流拿，每次可以拿 7-11 个瓶子，A 先拿，A 要怎么拿才能保证拿到第550个瓶子？
15. 手撕：https://leetcode.cn/problems/sudoku-solver/description/（这个题好像是返回唯一解，面试的题**要求返回有多少种解**）
